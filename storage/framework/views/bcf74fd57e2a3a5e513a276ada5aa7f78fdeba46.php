...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>>
  <head>
    ...
    <link href="<?php echo e(asset('assets/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css')); ?>" rel="stylesheet">
    <!-- JQVMap -->
    <link href="<?php echo e(asset('assets/vendors/jqvmap/dist/jqvmap.min.css')); ?>" rel="stylesheet"/>
    <!-- bootstrap-daterangepicker -->
    <link href="<?php echo e(asset('assets/vendors/bootstrap-daterangepicker/daterangepicker.css')); ?>" rel="stylesheet">
  ...
  <body class="nav-md">
   ...
   <div id="menu"></div>
    ...
    <!-- Chart.js -->
    <script src="<?php echo e(asset('assets/vendors/Chart.js/dist/Chart.min.js')); ?>"></script>
    <!-- gauge.js -->
    <script src="<?php echo e(asset('assets/vendors/gauge.js/dist/gauge.min.js')); ?>"></script>
    <!-- bootstrap-progressbar -->
    <script src="<?php echo e(asset('assets/vendors/bootstrap-progressbar/bootstrap-progressbar.min.js')); ?>"></script>
    <!-- iCheck -->
    ...
    <!-- JQVMap -->
    <script src="<?php echo e(asset('assets/vendors/jqvmap/dist/jquery.vmap.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendors/jqvmap/dist/maps/jquery.vmap.world.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js')); ?>"></script>
    <!-- bootstrap-daterangepicker -->
...
<?php /**PATH /var/www/html/react/resources/views/index.blade.php ENDPATH**/ ?>